...
const task = "C:\\Users\\User\\Desktop\\agentic\\3CA\\Q1_R11";
...
let originalInputs = 0, engineContinuations = 0, reasoningPresent = 0, reasoningMissing = 0, thinkingEnabled = 0, loopBreakers = 0, loopRecoveries = 0, structuredActions = 0, nativeFunctionRequests = 0, reusedResults = 0;
...
for (const file of sessionFiles.values()) {
  ...
  for (const event of events) {
    ...
    if (meta.event === "model_request" && meta.action_mode === "native_function_call") nativeFunctionRequests++;
