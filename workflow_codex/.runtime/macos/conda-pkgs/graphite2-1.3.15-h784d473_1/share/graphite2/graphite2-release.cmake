...
set_target_properties(gr2_graphite2 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgraphite2.3.3.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgraphite2.3.dylib"
  )

list(APPEND _cmake_import_check_targets gr2_graphite2 )
list(APPEND _cmake_import_check_files_for_gr2_graphite2 "${_IMPORT_PREFIX}/lib/libgraphite2.3.3.1.dylib" )
