...
set_target_properties(pcre2::pcre2-8-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpcre2-8.0.15.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpcre2-8.0.dylib"
  )

list(APPEND _cmake_import_check_targets pcre2::pcre2-8-shared )
list(APPEND _cmake_import_check_files_for_pcre2::pcre2-8-shared "${_IMPORT_PREFIX}/lib/libpcre2-8.0.15.0.dylib" )
...
set_target_properties(pcre2::pcre2-posix-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpcre2-posix.3.0.7.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpcre2-posix.3.dylib"
  )

list(APPEND _cmake_import_check_targets pcre2::pcre2-posix-shared )
list(APPEND _cmake_import_check_files_for_pcre2::pcre2-posix-shared "${_IMPORT_PREFIX}/lib/libpcre2-posix.3.0.7.dylib" )
...
set_target_properties(pcre2::pcre2-16-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpcre2-16.0.15.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpcre2-16.0.dylib"
  )

list(APPEND _cmake_import_check_targets pcre2::pcre2-16-shared )
list(APPEND _cmake_import_check_files_for_pcre2::pcre2-16-shared "${_IMPORT_PREFIX}/lib/libpcre2-16.0.15.0.dylib" )
...
set_target_properties(pcre2::pcre2-32-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpcre2-32.0.15.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpcre2-32.0.dylib"
  )

list(APPEND _cmake_import_check_targets pcre2::pcre2-32-shared )
list(APPEND _cmake_import_check_files_for_pcre2::pcre2-32-shared "${_IMPORT_PREFIX}/lib/libpcre2-32.0.15.0.dylib" )
