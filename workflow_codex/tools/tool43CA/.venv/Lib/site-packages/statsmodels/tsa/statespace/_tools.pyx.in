...
cpdef _{{prefix}}compute_smoothed_state_weights(
    ...
    prior_weights = np.PyArray_ZEROS(3, dim3, {{typenum}}, FORTRAN) * np.nan
    dim2[0] = p; dim2[1] = p;
    F = np.PyArray_ZEROS(2, dim2, {{typenum}}, FORTRAN)
    Fi = np.PyArray_ZEROS(2, dim2, {{typenum}}, FORTRAN)
    dim2[0] = m; dim2[1] = p;
    tmp = np.PyArray_ZEROS(2, dim2, {{typenum}}, FORTRAN)
    dim2[0] = p; dim2[1] = m;
